            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-edit me-2"></i>Edit Realisasi Kegiatan
                    </h3>
                </div>
                
                <div class="card-body">
                    <form action="{{ route('activity-realizations.update', $realization) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="plan_id" id="plan_id" class="form-select @error('plan_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($activityPlans as $plan)
                                            <option value="{{ $plan->id }}" {{ old('plan_id', $realization->plan_id) == $plan->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('date') is-invalid @enderror" 
                                           id="date" name="date" value="{{ old('date', $realization->date->format('Y-m-d')) }}" required>
                                    @error('date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3" required>{{ old('description', $realization->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select name="transaction_type" id="transaction_type" class="form-select @error('transaction_type') is-invalid @enderror" required>
                                        ...
                                        <option value="debit" {{ old('transaction_type', $realization->transaction_type) == 'debit' ? 'selected' : '' }}>Debit (Pengeluaran)</option>
                                        <option value="credit" {{ old('transaction_type', $realization->transaction_type) == 'credit' ? 'selected' : '' }}>Kredit (Pemasukan)</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('unit_price') is-invalid @enderror" 
                                               id="unit_price" name="unit_price" value="{{ old('unit_price', $realization->unit_price) }}" 
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('equivalent_1') is-invalid @enderror" 
                                           id="equivalent_1" name="equivalent_1" value="{{ old('equivalent_1', $realization->equivalent_1 ?? 1) }}" 
                                           min="0" step="0.01">
                                    @error('equivalent_1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('equivalent_2') is-invalid @enderror" 
                                           id="equivalent_2" name="equivalent_2" value="{{ old('equivalent_2', $realization->equivalent_2) }}" 
                                           min="0" step="0.01">
                                    @error('equivalent_2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('equivalent_3') is-invalid @enderror" 
                                           id="equivalent_3" name="equivalent_3" value="{{ old('equivalent_3', $realization->equivalent_3) }}" 
                                           min="0" step="0.01">
                                    @error('equivalent_3')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="card bg-light mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" id="total_amount" name="total_amount" value="{{ old('total_amount', $realization->total_amount) }}">
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-select @error('status') is-invalid @enderror">
                                        <option value="pending" {{ old('status', $realization->status) == 'pending' ? 'selected' : '' }}>Pending</option>
                                        <option value="confirmed" {{ old('status', $realization->status) == 'confirmed' ? 'selected' : '' }}>Confirmed</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
