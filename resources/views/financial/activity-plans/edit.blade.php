    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('activity-plans.update', $activityPlan) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('academic_year_id') is-invalid @enderror" id="academic_year_id" name="academic_year_id" required>
                                        ...
                                        @foreach($academicYears as $year)
                                            <option value="{{ $year->id }}" {{ old('academic_year_id', $activityPlan->academic_year_id) == $year->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   id="name" name="name" value="{{ old('name', $activityPlan->name) }}" required>
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('start_date') is-invalid @enderror" 
                                           id="start_date" name="start_date" value="{{ old('start_date', $activityPlan->start_date->format('Y-m-d')) }}" required>
                                    @error('start_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('end_date') is-invalid @enderror" 
                                           id="end_date" name="end_date" value="{{ old('end_date', $activityPlan->end_date->format('Y-m-d')) }}" required>
                                    @error('end_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card bg-light mb-3">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control @error('unit_price') is-invalid @enderror" 
                                                       id="unit_price" name="unit_price" value="{{ old('unit_price', $activityPlan->unit_price) }}" 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control @error('equivalent_1') is-invalid @enderror" 
                                                       id="equivalent_1" name="equivalent_1" value="{{ old('equivalent_1', $activityPlan->equivalent_1 ?? 1) }}" 
                                                       min="0" step="0.01">
                                                <input type="text" class="form-control" id="unit_1" name="unit_1" 
                                                       value="{{ old('unit_1', $activityPlan->unit_1 ?? 'pax') }}" placeholder="Unit">
                                            </div>
                                            @error('equivalent_1')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control @error('equivalent_2') is-invalid @enderror" 
                                                       id="equivalent_2" name="equivalent_2" value="{{ old('equivalent_2', $activityPlan->equivalent_2) }}" 
                                                       min="0" step="0.01">
                                                <input type="text" class="form-control" id="unit_2" name="unit_2" 
                                                       value="{{ old('unit_2', $activityPlan->unit_2 ?? 'orang') }}" placeholder="Unit">
                                            </div>
                                            @error('equivalent_2')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control @error('equivalent_3') is-invalid @enderror" 
                                                       id="equivalent_3" name="equivalent_3" value="{{ old('equivalent_3', $activityPlan->equivalent_3) }}" 
                                                       min="0" step="0.01">
                                                <input type="text" class="form-control" id="unit_3" name="unit_3" 
                                                       value="{{ old('unit_3', $activityPlan->unit_3 ?? 'kegiatan') }}" placeholder="Unit">
                                            </div>
                                            @error('equivalent_3')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <input type="hidden" id="budget_amount" name="budget_amount" value="{{ old('budget_amount', $activityPlan->budget_amount) }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3">{{ old('description', $activityPlan->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
