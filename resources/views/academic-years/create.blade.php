...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Tahun Ajaran Baru</h1>
            ...
            <form action="{{ route('academic-years.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('year_start') is-invalid @enderror" 
                                   id="year_start" name="year_start" value="{{ old('year_start') }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('year_end') is-invalid @enderror" 
                                   id="year_end" name="year_end" value="{{ old('year_end') }}" 
                                   min="2000" max="2100" required>
                            @error('year_end')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              ...
                              placeholder="Contoh: Tahun Ajaran 2024/2025">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-fill year_end when year_start changes
